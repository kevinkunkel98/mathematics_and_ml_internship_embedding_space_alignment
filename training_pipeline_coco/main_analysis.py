...
from probing.get_activations import extract_and_save_activations, postprocess_language, postprocess_vision
from data.dataloader import load_data
### MODELLE LADEN 
MODEL_KEYS = {"model_id", "m_type", "probe_layer", "hidden_dim", "lora", "token"}

MODEL_DIRS = [
    "training/models/vision/dinov2_coco_multilabel/20260616_102002",
    "training/models/language/llama_3B_coco_multilabel/20260616_120118",
]
...
def process_model(exp_dir):
    ...
    # 7) Aktivierungen ziehen
    extract_and_save_activations(
        model=model, save_dir=save_dir, postprocess_fn=postprocess_fn,
